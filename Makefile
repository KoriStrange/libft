...
srcs = ft_strlen.c ft_strdup.c ft_strcpy.c ft_strncpy.c ft_isalpha.c ft_isdigit.c \
      ...
      ft_memset.c ft_bzero.c ft_isascii.c ft_isprint.c ft_putchar.c ft_putstr.c ft_putnbr.c 
...
objs = ft_strlen.o ft_strdup.o ft_strcpy.o ft_strncpy.o ft_isalpha.o ft_isdigit.o \
      ...
      ft_memset.o ft_bzero.o ft_isascii.o ft_isprint.o ft_putchar.o ft_putstr.o ft_putnbr.o
