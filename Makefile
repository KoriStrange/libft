...
srcs = ft_strlen.c ft_strdup.c ft_strcpy.c ft_strncpy.c ft_isalpha.c ft_isdigit.c \
      ...
      ft_strstr.c ft_strnstr.c ft_isascii.c ft_isprint.c \
      ...
      ft_strjoin.c ft_strtrim.c ft_putchar.c ft_putstr.c ft_putendl.c ft_putnbr.c \
...
objs = ft_strlen.o ft_strdup.o ft_strcpy.o ft_strncpy.o ft_isalpha.o ft_isdigit.o \
      ...
      ft_memcmp.o ft_strcat.o ft_strncat.o ft_strlcat.o ft_strchr.o ft_strrchr.o \
      ft_strstr.o ft_strnstr.o ft_isascii.o ft_isprint.o \
      ...
      ft_strjoin.o ft_strtrim.o ft_putchar.o ft_putstr.o ft_putendl.o ft_putnbr.o \
